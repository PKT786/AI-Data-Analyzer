...
def render_auth_gate() -> None:
    """Login / Sign up gate shown before the platform unlocks."""

    st.markdown(
        """
        <div class="pth-cta-card">
            <div class="pth-cta-title">Welcome to AI Data Analyzer Pro</div>
            <div class="pth-cta-sub">Log in or create a free account to start turning raw data into decisions.</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
